  ...
  return (
    <div className='rounded-div my-12 py-8'>
      <div className='flex py-8'>
        <img className='w-20 h-20 mr-8' src={coin.image?.large} alt="/" />
        <div>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div>
            <div className='flex justify-between'>
              {coin.market_data?.current_price ? (<p className='text-3xl font-bold'>${coin.market_data.current_price.cad.toLocaleString()}</p>) : null}
              <p>7 Day</p>
            </div>
            <div>
            ...
            <div className='flex justify-between py-4'>
              ...
              <div>
                ...
                {coin.market_data?.market_cap ? (<p>${coin.market_data.total_volume.cad.toLocaleString()}</p>) : null}
              </div>
            </div>
            <div className='flex justify-between py-4'>
              <div>
